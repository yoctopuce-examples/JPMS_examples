...
javac -d outDir --module-source-path Sources --module-path ..\YoctoLib.java.40924\Binaries\yoctoAPI.jar Sources\hello.module\com\mycompany\module\MyModule.java
